...
{
    public class TradeApiTests : IClassFixture<CustomWebApplicationFactory<Startup>>
    {
        private readonly CustomWebApplicationFactory<Startup> _factory;
        private readonly HttpClient _client;

        private const string APIROUTE = "api/trade/";

        public TradeApiTests(CustomWebApplicationFactory<Startup> factory)
        {
            _factory = factory;
        ...
        [Fact]
        public void Get_ReturnsOk_WithListOfTradeResources()
        {
            // Act
            ...
            var result = JsonConvert.DeserializeObject<IEnumerable<TradeResource>>(json);

            Assert.IsType<List<TradeResource>>(result);
        }
        ...
        [Fact]
        public void GetById_ReturnsOk_WithTradeResource()
        {
            ...
            // Act
            var response = _client.AuthorizeRequest().GetAsync(APIROUTE + resource.TradeId).Result;
            response.EnsureSuccessStatusCode();
        ...
        public void Delete_ReturnsOk()
        {
            ...
            // Act
            var response = _client.AuthorizeRequest().DeleteAsync(APIROUTE + resource.TradeId).Result;
